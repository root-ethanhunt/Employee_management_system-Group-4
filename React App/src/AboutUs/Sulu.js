...
import img1 from "./images/tui.png";
    ...
    <div data-spy="scroll" data-target=".navbar">
        ...
        <nav className="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
          <div className="container">
            ...
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item">
                <a href="" target="blank" className="nav-link">
                  Resume
                </a>
              </li>
              <li className="nav-item">
                ...
                <div className="card bg-white">
                  <div className="card-title my-5">
                    <div className="media d-flex">
                      ...
                      >
                        <h3 className="display-4 ml-5">I'm Sulagna Deb</h3>
                  ...
                  <div className="card-footer bg-danger" id="aboutup">
                    ...
                    {/* <a href="#"><img src={img5} width="24" height="24" className="mx-3" /></a> */}
                  </div>
                </div>
              </div>
            </div>
      ...
      <div id="Skills" className="mt-5">
        <div className="container">
          ...
          <div className="row">
            <div className="col">
              <div className="card bg-white p-3">
                <h5 className="ml-3 my-3 fw-bold">C Programming</h5>
                ...
                <h5 className="ml-3 my-3 fw-bold">Python</h5>
                <div className="progress">
                  <div className="progress-bar" style={{ width: "85%" }}>
                    85%
                  </div>
                </div>
                <h5 className="ml-3 my-3 fw-bold">Java Programming</h5>
                <div className="progress">
          ...
          <div className="row">
            <div className="col">
              <div className="card bg-white p-3">
                <h5 className="ml-3 my-3 fw-bold">HTML5 Language</h5>
                <div className="progress">
                  <div className="progress-bar" style={{ width: "95%" }}>
                    95%
                  </div>
                </div>
                <h5 className="ml-3 my-3 fw-bold">CSS3 Language</h5>
                <div className="progress">
                  <div className="progress-bar" style={{ width: "95%" }}>
                    95%
                  </div>
                </div>
                <h5 className="ml-3 my-3 fw-bold">JavaScript Language</h5>
                <div className="progress">
          ...
          <div className="row">
            <div className="col">
              <div className="card bg-white p-3">
                <h5 className="ml-3 my-3 fw-bold">MS-Word</h5>
                <div className="progress">
                  <div className="progress-bar" style={{ width: "100%" }}>
                    100%
                  </div>
                </div>
                <h5 className="ml-3 my-3 fw-bold">MS- Power Point</h5>
                <div className="progress">
                  <div className="progress-bar" style={{ width: "90%" }}>
                    90%
                  </div>
                </div>
                <h5 className="ml-3 my-3 fw-bold" id="experienceup">
                  {" "}
                  MS-Excel
                </h5>
                <div className="progress">
            ...
            <div className="col-lg-6">
              <div className="card bg-white">
                <img
                  ...
                  className="img-fluid m-auto py-3"
                />
                <h3 className="text-center text-success mt-3 fw-bold">
      ...
      {/* <div className="container-fluid bg-success">
        <div className="row">
            <div className="col">
                <div className="container">
                    <p className="text-white pt-3 text-center">©Made By Group4</p>
                </div>
            </div>
        </div>
    </div> */}
