...
import img1 from "./images/VIKASH_KUMAR.jpeg";
        ...
        <nav className="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
          <div className="container">
            ...
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item">
                <a
                  href="https://drive.google.com/file/d/1fHLDFmqqu2CRfn-yFJu3C6fm2rdhm_no/view?usp=sharing"
                  className="nav-link"
                  target="blank"
                >
                  Resume
                ...
                <div className="card bg-white">
                  <div className="card-title my-5">
                    <div className="media d-flex">
                      ...
                      >
                        <h3 className="display-4 ml-5">I'm Vikash Kumar</h3>
                        ...
                        <table className="table table-responsive ml-5">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>:</td>
                              <td>vikashkumar.network@gmail.com</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>:</td>
                              <td>Worked on Backend Form Validation part</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
