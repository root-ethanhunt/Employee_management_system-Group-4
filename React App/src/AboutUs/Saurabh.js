...
import img1 from "./images/SAURABH_KUMAR.jpg";
        ...
        <nav className="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
          <div className="container">
            ...
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item">
                <a
                  href="https://drive.google.com/drive/folders/1hZMBS-YNLuNaAYZwghLarKbn9CUCKUyD"
                  target="blank"
                  className="nav-link"
                >
                  Resume
                ...
                <div className="card bg-white">
                  <div className="card-title my-5">
                    <div className="media d-flex">
                      ...
                      >
                        <h3 className="display-4 ml-5">I'm Saurabh Kumar</h3>
                        ...
                        <table className="table table-responsive ml-5">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>:</td>
                              <td>saurabhvardhan001@gmail.com</td>
                            </tr>
                            <tr>
                  ...
                  <div className="card-footer bg-danger" id="aboutup">
                    <a href="https://www.facebook.com/sulagna.deb.1">
                      <img src={img2} width="24" height="24" className="mx-3" />
                    </a>
                    <a href="https://www.linkedin.com/in/sulagna-deb-327435217/">
                      <img src={img3} width="24" height="24" className="mx-3" />
                    </a>
                    <a href="https://www.instagram.com/sulagna_deb.1/">
          ...
          <div className="row">
            <div className="col">
              ...
              <p className="lead text-justify" id="skillup">
                Software enthusiast with excellent problem solving skills and
