...
import img1 from "./images/Sripriya.jpeg";
        ...
        <nav className="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
          <div className="container">
            ...
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item">
                <a href="Sulagna Deb.pdf" className="nav-link">
                  Resume
                </a>
              </li>
              <li className="nav-item">
                ...
                <div className="card bg-white">
                  <div className="card-title my-5">
                    <div className="media d-flex">
                      ...
                      >
                        <h3 className="display-4 ml-5">I'm Sripriya Ghoshal</h3>
                        ...
                        <table className="table table-responsive ml-5">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>:</td>
                              <td> sripriyaghosal19@gmail.com</td>
                            </tr>
                            <tr>
                  ...
                  <div className="card-footer bg-danger" id="aboutup">
                    <a
                      href="https://www.facebook.com/sripriya.ghosal.5"
                      target="blank"
                    >
                      <img src={img2} width="24" height="24" className="mx-3" />
                    </a>
                    <a
                      href="https://www.linkedin.com/in/sripriya-ghosal-85557021a"
                      target="blank"
                    >
                      <img src={img3} width="24" height="24" className="mx-3" />
                    </a>
                    <a
                      href="https://www.instagram.com/invites/contact/?i=12uy1afoe1lfk&utm_content=o295lyk"
                      target="blank"
                    >
