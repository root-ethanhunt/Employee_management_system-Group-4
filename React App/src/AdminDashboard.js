    ...
    <div style={{ height: "190px" }}>
        ...
        <div className="w3-panel" id="Admin">
          ...
          >
            ...
            >
              ...
              >
                You are now the most responsible person of our organization. You
                can access out total Database. We have given you the
                responsibiity of total database. So, whatever you will do, do it
                properly and carefully. Otherwise a small mistake can do extreme
              ...
              >
                ...
                developer<br></br>
                <Link to="/about/panda"> Subhabrata Panda</Link> (Backend) /{" "}
                <Link to="/about/rupam"> Rupam Halder</Link> (Frontend)
                <br />
                <br />
                Or if you want any help from management then contact to-
                <br></br>
                <Link to={`/AllEmpFindByDept/${13}`}> Managing Department</Link>
              </p>
            </div>
          </div>
        </div>
      ...
      {/* <marquee direction="right">
        <div>
          <img
            src={img5}
            style={{ width: "140px", height: "120px", paddingTop: "60px" }}
          />
        </div>
      </marquee> */}
    </div>
