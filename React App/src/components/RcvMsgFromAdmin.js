...
import msg2 from "./SendMsgByAdmin";
import { msgsend } from "./SendMsgByAdmin";
import SendMsgByAdmin from "./SendMsgByAdmin";
          ...
          >
            <div className="w3-twothird">
              ...
              <div className="form-group">
                <h6>Hello, Welcome to our organization</h6>
              </div>
            </div>
          </div>
        </div>
