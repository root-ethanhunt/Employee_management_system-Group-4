...
const EmployeeList = () => {
  ...
  const searchEmp = () => {
    // setErrAlert(false);
    employeeService
      .findIdByName(findemp)
      .then((response) => {
        console.log(response.data + " - emp id, Emp Name:-  " + findemp);
        history.push(`/FindEmp/${response.data}`);
      })
      .catch(() => {
        setErrAlert(true);
        // alert(findemp + " doesn't exist in the data base");
      });
  };
            ...
            <div className="w3-twothird">
              ...
              {errAlert && (
                ...
                >
                  ...
                  <p> doesn't exist in the data base</p>
                  <button
                    type="button"
                    class="btn-close"
              ...
              <div className="container" style={{ paddingRight: "20px" }}>
                <div className="form-group">
                  <input
                    ...
                    id="search"
                    value={findemp}
                    onChange={(s) => setFindemp(s.target.value)}
                    ...
                    <tbody>
                      {allEmployee.map((employee) => (
                        <tr key={employee.eid}>
                          ...
                          <td>
                            <Link to={`/allEmployee/edit/${employee.eid}`}>
                              <img src={img3} className="edit_img"></img>
                            </Link>
                            ...
                            >
                              <img src={img4} className="delete_img"></img>
                            </button>
                          </td>
                        </tr>
                      ))}
